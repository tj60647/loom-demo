...
const student: Flow = {
  ...
  nodes: [
    ...
    { id: "read", label: "Read the text", where: "00 · Reading" },
    { id: "capture", label: "Highlight a passage", where: "00 · Reading" },
    { id: "file", label: "Name the concept it evidences — or leave it unlabeled", where: "01 · Open" },
    ...
    { id: "weave", label: "Every reading at once", where: "05 · Weave" },
    { id: "keep", label: "Export the cloth or a projection", where: "06 · Keep", kind: "end" },
  ],
  edges: [
