...
const GUIDE = [
 {k:'how loom works', h:'Loom turns reading into weaving',
  ...
  loom:'Three moves, in order: 01 Open · 02 Linking · 04 Knowledge Graph, where you lay it out and read it. 03 Vocabulary is the words you have collected along the way. 00 Library is where you start and 05 Weave is every reading at once; 06 Keep is where your work comes out.'},
 {k:'01 — open', h:'① Capture and name',
  p:'Paste a passage worth keeping, with its citation. Name the concept it evidences — a short noun phrase, often the author\'s own term ("boundary objects"). Then gloss it in your own words in the description; crude is welcome there.',
 ...
 {k:'03 — vocabulary', h:'③ The words you own',
 ...
 {k:'04 — knowledge graph', h:'④ Sort, arrange, and read the cloth',
 ...
 {k:'after loom', h:'⑤ Where this goes next',
  p:'Your weave is the middle step, not the deliverable. Copy the concept-map kit and draw your real concept map by hand (arranging is thinking), build your chalk talk from it, and export your graph from 06 · Keep (JSON) — yours to keep, submit, or explore further.',
