...
const GUIDE = [
 {k:'how loom works', h:'Loom turns reading into weaving',
  ...
  loom:'Three moves, in order: 01 Reading · 02 Linking · 04 Knowledge Graph, where you lay it out and read it. 03 Vocabulary is the words you have collected along the way. 00 Library is where you start, and Keep is where your work comes out.'},
